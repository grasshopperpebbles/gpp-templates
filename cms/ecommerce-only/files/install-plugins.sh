...
#===============================================================================
# WordPress Plugin Installation Script - E-commerce Only
#===============================================================================
# This script installs and configures plugins for headless WooCommerce
# (No blog/CMS features - pure e-commerce)
#===============================================================================
...
SITE_TAGLINE="${SITE_TAGLINE:-Your one-stop shop for amazing products}"
...
STORE_CITY="${STORE_CITY:-New York}"
STORE_STATE="${STORE_STATE:-NY}"
STORE_POSTCODE="${STORE_POSTCODE:-10001}"
STORE_COUNTRY="${STORE_COUNTRY:-US}"
STORE_CURRENCY="${STORE_CURRENCY:-USD}"
ENABLE_TAXES="${ENABLE_TAXES:-false}"
...
echo "🚀 Setting up headless WooCommerce environment (E-commerce only)..."
echo "================================================="
echo "  Site Name: $SITE_NAME"
echo "  Site URL: $SITE_URL"
echo "  Frontend URL: $FRONTEND_URL"
echo "  Admin: $ADMIN_USER"
echo "  Mode: E-commerce Only (no blog features)"
echo "================================================="
...
#-------------------------------------------------------------------------------
# Install Core Plugins (E-commerce Only - No CMS plugins)
#-------------------------------------------------------------------------------

echo ""
echo "🔌 Installing essential plugins (E-commerce only)..."
echo "=================================="

# WooCommerce (always enabled for ecommerce-only)
...
# Activate custom plugins (E-commerce focused - no CMS plugins)
...
if ! wp post list --post_type=page --name=about --field=ID --allow-root --quiet 2>/dev/null | grep -q .; then
    wp post create --post_type=page --post_title="About" --post_name="about" \
        --post_content="<h2>About Our Store</h2><p>Welcome to $SITE_NAME! $SITE_TAGLINE</p>" \
...
echo ""
echo "✅ E-commerce-only setup completed successfully!"
echo "=============================="
echo ""
